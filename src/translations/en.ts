...
const en = {
  ...
  book: {
    create: {
      badge: "Create a new book",
      title: "Publish a new book",
      description: "Add your next story, essay, or collection with a polished, reader-first experience.",
      helper: "You can upload a cover image and fill in the core details below.",
      coverTitle: "Book cover",
      uploadLabel: "Drop your cover here",
      uploadHint: "PNG, JPG, or WebP up to 10MB",
      ...
      genreLabel: "Genre",
      genrePlaceholder: "e.g. Fiction, Memoir",
      descriptionLabel: "Description",
      descriptionPlaceholder: "Write a short summary for readers",
      submit: "Create book",
      cancel: "Cancel",
    },
    reader: {
      title: "Reading view",
      chapterLabel: "Chapter navigator",
      previous: "Previous",
      next: "Next",
      empty: "No reader content available",
    },
    details: {
